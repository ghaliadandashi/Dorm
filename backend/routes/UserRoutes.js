...
const { register, login, validate, user, logout,profile,getDorm, changeProfilePic,deleteProfilePic,profileEdit, getInsights, search} = require('../controllers/userController');
